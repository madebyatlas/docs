...
export const myLinks = [
  ...
  { href: 'https://bd.madebyatlas.dev', label: 'Ban Database Bot Dashboard' },
  { href: 'https://lenny.madebyatlas.dev', label: 'Lenny Bot Dashboard' },
  { href: 'https://uptime.madebyatlas.dev', label: 'Uptime Bot Dashboard' },
