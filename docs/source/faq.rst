...
^^^^^
**A:** Bans for certain reasons are able to be appealed. We do not allow appeals for any action that directly violated Rule #1 or Rule #3 in our Discord rules. `[Ban Appeal Form] <https://madebyatlas.dev/ban-appeal>`_
